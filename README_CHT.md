...
-----------|---
藍牙 | 顯然需要藍牙存取權。請選擇 *好*。
輔助使用 | 這是用來解鎖鎖定畫面所必需。macOS 13 或更新版本：開啟 *系統設定* > *隱私權與安全性* > *輔助使用*，並啟用 BLEUnlock。macOS 12 或更舊版本：開啟 *系統偏好設定* > *安全性與隱私權* > *隱私權* > *輔助使用*，先按左下角的鎖頭解鎖，再啟用 BLEUnlock。
...
確認已在對應版本的「輔助使用」設定中啟用 BLEUnlock：

- macOS 13 或更新版本：*系統設定* > *隱私權與安全性* > *輔助使用*
- macOS 12 或更舊版本：*系統偏好設定* > *安全性與隱私權* > *隱私權* > *輔助使用*。如需變更，先按左下角的鎖頭解鎖。
